...
const Hero = () => {
  return (
    <section
      id="home"
      className="flex items-center bg-gradient-to-br from-green-50 to-blue-50 pt-20"
    >
      <div className="w-full max-w-6xl mx-auto px-6 md:px-10 lg:px-16 xl:px-20 py-12 md:py-16">
