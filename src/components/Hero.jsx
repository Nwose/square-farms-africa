...
//       <div className="w-full max-w-6xl mx-auto px-6 md:px-10 lg:px-16 xl:px-20 py-16 md:py-20">
    ...
    >
      <div className="w-full max-w-6xl mx-auto px-6 md:px-10 lg:px-16 xl:px-20 py-16 md:py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Left content */}
          <div className="space-y-8 animate-fade-in">
            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-green-800 leading-tight">
              Empowering Nigerian
              <span className="text-green-600"> Agriculture</span>
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-10 pt-8">
              <div className="text-center">
                <div className="flex justify-center mb-2">
                  <Sprout className="text-3xl sm:text-4xl text-green-800" />
                </div>
          ...
          <div className="relative animate-scale-in">
            <div className="relative bg-gradient-to-br from-green-700 to-green-500 rounded-3xl p-6 sm:p-8 text-white">
              ...
              <img
                src="https://images.unsplash.com/photo-1472396961693-142e6e269027?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
                alt="Nigerian Agriculture"
                className="relative z-10 w-full h-64 sm:h-80 md:h-96 lg:h-[28rem] object-cover rounded-2xl"
              />
              <div className="relative z-10 mt-4 sm:mt-6">
                <h3 className="text-lg sm:text-xl font-semibold mb-2">
                  Sustainable Growth
